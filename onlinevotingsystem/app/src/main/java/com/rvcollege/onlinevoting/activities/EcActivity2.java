...
public class EcActivity2 extends AppCompatActivity implements View.OnClickListener {

    private final AppCompatActivity activity = EcActivity2.this;
    ...
    private void initObjects() {
        ...
        databaseHelper2 = new Belagavidb(activity);
    ...
    private void postDataToSQLite() {
        ...
        if (!databaseHelper2.checkUser(textInputEditTextPartyName.getText().toString().trim())) {
        ...
        } else if(databaseHelper2.checkUser(textInputEditTextPartyName.getText().toString().trim())) {
