...
public class EcActivity3 extends AppCompatActivity implements View.OnClickListener {

    private final AppCompatActivity activity = EcActivity3.this;
    ...
    private void initObjects() {
        ...
        databaseHelper3 = new Mysore(activity);
    ...
    private void postDataToSQLite() {
        ...
        if (!databaseHelper3.checkUser(textInputEditTextPartyName.getText().toString().trim())) {
        ...
        } else if(databaseHelper3.checkUser(textInputEditTextPartyName.getText().toString().trim())) {
